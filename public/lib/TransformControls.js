...
THREE.TransformGizmoTranslate = function () {
	...
	this.handleGizmos = {
		...
		XZ: [
			new THREE.Mesh( new THREE.CircleGeometry(1, 20 ), new THREE.TransformGizmoMaterial( { color: 0xff00ff, opacity: 0.25 } ) ),
			new THREE.Vector3( 0, 0, 0 ),
			new THREE.Vector3( -Math.PI/2, 0, 0 )
		]
	...
	this.pickerGizmos = {
		...
		XZ: [
			new THREE.Mesh( new THREE.CircleGeometry( 1, 10 ), new THREE.TransformGizmoMaterial( { color: 0xff00ff, opacity: 0.25 } ) ),
			new THREE.Vector3( 0, 0, 0 ),
			new THREE.Vector3( -Math.PI/2, 0, 0 )
		]
...
THREE.TransformControls = function ( camera, domElement ) {
	...
	// var ballTexture = THREE.ImageUtils.loadTexture( '../images/sprite0.png' );
	...
	// ballSprite.scale.set( 1.5, 1.5, 1.0 );
	// ballSprite.position.set( 0, 10, 10 );
	...
	this.detach = function ( object ) {
		//scope.object.remove(ballSprite);
